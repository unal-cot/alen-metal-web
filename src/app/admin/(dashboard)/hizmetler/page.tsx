...
const serviceIcons = [
  { value: "fence", label: "Tel Çit" },
  { value: "grid_on", label: "Panel Çit" },
  { value: "grass", label: "Çim Çit" },
  { value: "grid_view", label: "Desenli Çit" },
  { value: "door_sliding", label: "Otomatik Kapı" },
  { value: "door_front", label: "Kapı" },
  { value: "garage_door", label: "Garaj Kapısı" },
  { value: "architecture", label: "Mimari / Dekoratif" },
  { value: "handyman", label: "Ferforje / El İşi" },
  ...
  { value: "factory", label: "Fabrika / Endüstri" },
